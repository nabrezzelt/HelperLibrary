...
namespace HelperLibrary.Emoticons
{
    public class Emoticon
    {
        private const string BaseUri = "http://cdn.jsdelivr.net/emojione/assets/png/";
        public static readonly Dictionary<string, string> Map = new Dictionary<string, string>
        {
            { "grinning", "1F600" }, // --start: Smileys
            { "innocent", "1F607" },
            { "smiling_imp", "1F608" },
            { "sunglasses", "1F60E" },
            { "neutral_face", "1F610" },
            ...
            { "astonished", "1F632" },
            { "flushed", "1F633" },
            { "dizzy_face", "1F635" }, // --end: Smileys

            { "mask", "1F637" },   // -- start: Fingers/Hands
            { "point_up", "261D" },
            { "point_up_2", "1F446" },
            { "point_down", "1F447" },
            { "point_left", "1F448" },
            ...
            { "thumbsdown", "1F44E" },
            { "clap", "1F44F" },
            { "open_hands", "1F450" }, // -- end: Fingers/Hands
        ...
        public static string ConvertShortnameToUnicode(string shortName)
        {
            return Map.TryGetValue(shortName, out string val) ? val : null;
        }

        public static string UnicodeToUrl(string unicode)
        {
            return string.Format(BaseUri + unicode + ".png");
        }

        public static string ShortnameToUri(string shortName)
        {
            var unicode = ConvertShortnameToUnicode(shortName);
            return String.IsNullOrEmpty(unicode) ? null : UnicodeToUrl(unicode);
        }
    }
}
